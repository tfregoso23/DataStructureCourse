...
public:
    ...
    void compoundInterestRecursive(double monthlyDeposit, double interest, int years, int year, double total, double payments, double interestEarned)
    {
        ...
        else
        {
            ...
            compoundInterestRecursive(monthlyDeposit, interest, years, year, total, payments, interestEarned); //function calls back itself using previous data
        }
    }
};
...
int main()
{
    ...
    cout << "Showing iterative: " <<endl;
    rec->compoundInterestIterative(200.00, 5, 20);
    cout << endl;
    cout << "Showing recursive: " <<endl;
